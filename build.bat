...
set OPTIONS=-nologo -W4 -Zi -wd4201 -wd4100 -wd4189 -Iext\SDL -Iext\embree-4.4.0\include /Oi /O2 /arch:AVX512

cl %OPTIONS% -c src\main.c /Fo:main.obj
cl %OPTIONS% -c src\cie_xyz_lut.c /Fo:cie_xyz_lut.obj
cl %OPTIONS% -c src\bvh.c /Fo:bvh.obj

cl -nologo /Fe:kingfisher main.obj cie_xyz_lut.obj %LIBS% -link /SUBSYSTEM:CONSOLE
